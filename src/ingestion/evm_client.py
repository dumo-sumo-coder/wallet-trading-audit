...
class EvmWalletClient:
    ...
    `chain_id="56"`. Callers may override `api_url` or `chain_id` if they have
    another Etherscan-compatible source.
    """
    ...
    # TODO: Revisit provider selection if Etherscan tiering for BNB mainnet
    # proves too restrictive for the intended ingestion workflow.
    ...
    def __init__(
        ...
        *,
        ...
        self.api_key = api_key or os.getenv("ETHERSCAN_API_KEY") or os.getenv("BSCSCAN_API_KEY")
    ...
    def fetch_recent_transaction_history(
        ...
        *,
        ...
        if not self.api_key:
            raise ValueError(
                "EvmWalletClient requires an ETHERSCAN_API_KEY or BSCSCAN_API_KEY"
            )
